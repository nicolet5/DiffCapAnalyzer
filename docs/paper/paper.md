...
## Acknowledgments
This project was supported by: Data Intensive Research Enabling Clean Technology (DIRECT) National Science Foundation (NSF) National Research Traineeship (DGE-1633216), the University of Washington (UW) Molecular Engineering Materials Center, a Materials Research Science and Engineering Center (DMR-1719797), NSF Graduate Research Fellowship Program under Grant No. DGE-1762114 to S.A., the State of Washington through the UW Clean Energy Institute and the UW  eScience Institute, and via funding from the Washington Research Foundation.
